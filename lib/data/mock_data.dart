...
const users = [
  ...
  AppUser(
    id: 'KJ01',
    name: 'En Ahmad (Ketua Jabatan)',
    email: 'kj_elektrik@tvetmara.edu.my',
    role: UserRole.ketuaJabatan,
    department: 'elektrik',
    active: true,
    lastLogin: '2026-04-29 09:00',
  ),
  AppUser(
    id: 'KP01',
    name: 'Pn Hasnah (Ketua Program)',
...
final disciplineReports = [
  ...
  DisciplineReport(
    ...
    studentName: students[15].name,
    section: 'DED 1A',
    subject: 'Komunikasi Bahasa Inggeris',
    lecturer: 'Pn Norhati',
    date: '2026-05-19',
    issueType: 'Ponteng Kelas',
    severity: 'Medium',
    description: 'Pelajar ponteng kelas hari ini.',
    followUp: false,
    status: 'New',
  ),
];
...
const bookings = [
  ...
  BookingRequest(
    id: 'B002',
    lecturerId: 'L002',
    lecturerName: 'Pn Norhati',
    subject: 'Komunikasi Bahasa Inggeris',
    section: 'DED 1A',
    originalDate: '2026-05-19',
    originalTime: '11:00 - 12:00',
    replacementDate: '2026-05-20',
    replacementStart: '08:00',
    replacementEnd: '09:00',
    room: 'BILIK KULIAH DED 2',
    reason: 'Kecemasan',
    remarks: 'Terdapat urusan kecemasan.',
    status: 'Pending',
  ),
];
